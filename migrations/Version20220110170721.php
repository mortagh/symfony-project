 ...
 */
final class Version20220110170721 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE musique (id INT AUTO_INCREMENT NOT NULL, artiste_id INT NOT NULL, album_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, date DATE NOT NULL, INDEX IDX_EE1D56BC21D25844 (artiste_id), INDEX IDX_EE1D56BC1137ABCF (album_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
